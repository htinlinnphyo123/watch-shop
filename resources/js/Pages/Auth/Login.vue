...
<template>
    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-50 text-gray-900">
        <div class="mb-8 text-center flex flex-col items-center">
             ...
             <h1 class="text-3xl font-bold tracking-widest uppercase">Time On You Admin</h1>
             <p class="text-sm text-gray-600 mt-2">Sign in to manage inventory and sales</p>
        </div>
            ...
            <form @submit.prevent="submit">
                <div>
                    ...
                    <TextInput
                        id="email"
                        type="email"
                        class="mt-1 block w-full bg-white border-gray-300 text-gray-900 focus:border-gold-500 focus:ring-gold-500"
                        v-model="form.email"
                        required
                        autofocus
                ...
                <div class="block mt-6">
                    <label class="flex items-center">
                        <Checkbox name="remember" v-model:checked="form.remember" class="border-gray-300 bg-white text-gold-500 focus:ring-gold-500" />
                ...
                <div class="flex items-center justify-between mt-8">
                    ...
                    <PrimaryButton class="bg-gold-500 hover:bg-gold-600 text-white font-bold px-8 py-3 rounded-md transition-all uppercase tracking-wider text-sm" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                        Log In
                    </PrimaryButton>
                </div>
            </form>
        ...
        <div class="mt-12 text-sm text-gray-600 text-center">
            &copy; {{ new Date().getFullYear() }} Time On You Admin Portal. All rights reserved.
        </div>
    </div>
</template>
