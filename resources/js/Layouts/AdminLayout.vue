    ...
    <div class="min-h-screen bg-gray-100 font-sans">
        ...
        <aside
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                <Link :href="route('dashboard')" :class="{ 'text-gold-600 bg-gold-50': route().current('dashboard') }"
                ...
                <div>
                    <div class="text-xs font-semibold text-gray-400 uppercase tracking-wider mt-6 mb-2 ml-4">Inventory
                    </div>

                    <Link :href="route('categories.index')"
                        :class="{ 'text-gold-600 bg-gold-50': route().current('categories.*') }"
                        class="flex items-center px-4 py-3 text-gray-600 hover:bg-gray-100 hover:text-gray-900 rounded-lg transition-colors">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <Link :href="route('collections.index')"
                        :class="{ 'text-gold-600 bg-gold-50': route().current('collections.*') }"
                        class="flex items-center px-4 py-3 text-gray-600 hover:bg-gray-100 hover:text-gray-900 rounded-lg transition-colors">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <Link :href="route('banners.index')"
                        :class="{ 'text-gold-600 bg-gold-50': route().current('banners.*') }"
                        class="flex items-center px-4 py-3 text-gray-600 hover:bg-gray-100 hover:text-gray-900 rounded-lg transition-colors">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="text-xs font-semibold text-gray-400 uppercase tracking-wider mt-6 mb-2 ml-4">Sales &
                    Operations</div>
                ...
                <Link v-if="$page.props.auth.user.role === 'admin'" :href="route('low-stock-notifications.index')"
                    :class="{ 'text-gold-600 bg-gold-50': route().current('low-stock-notifications.*') }"
                    class="flex items-center px-4 py-3 text-gray-600 hover:bg-gray-100 hover:text-gray-900 rounded-lg transition-colors">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    Low Stock
                    <span v-if="$page.props.low_stock_pending_count"
                ...
                <Link :href="route('customers.index')"
                    :class="{ 'text-gold-600 bg-gold-50': route().current('customers.*') }"
                    class="flex items-center px-4 py-3 text-gray-600 hover:bg-gray-100 hover:text-gray-900 rounded-lg transition-colors">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <Link :href="route('wallet.index')" :class="{ 'text-gold-600 bg-gold-50': route().current('wallet.*') }"
                    class="flex items-center px-4 py-3 text-gray-600 hover:bg-gray-100 hover:text-gray-900 rounded-lg transition-colors">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    {{ $page.props.auth.user.role === 'admin' ? 'User Wallets' : 'My Wallet' }}
                </Link>

                <div v-if="$page.props.auth.user.role === 'admin'"
                    class="text-xs font-semibold text-gray-400 uppercase tracking-wider mt-6 mb-2 ml-4">System</div>
                ...
                <Link v-if="$page.props.auth.user.role === 'admin'" :href="route('customer-groups.index')"
                    :class="{ 'text-gold-600 bg-gold-50': route().current('customer-groups.*') }"
                    class="flex items-center px-4 py-3 text-gray-600 hover:bg-gray-100 hover:text-gray-900 rounded-lg transition-colors">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z">
                ...
                <Link v-if="$page.props.auth.user.role === 'admin'" :href="route('top-level-discounts.index')"
                    :class="{ 'text-gold-600 bg-gold-50': route().current('top-level-discounts.*') }"
                    class="flex items-center px-4 py-3 text-gray-600 hover:bg-gray-100 hover:text-gray-900 rounded-lg transition-colors">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <Link v-if="$page.props.auth.user.role === 'admin'" :href="route('settings.index')"
                ...
                <div class="flex items-center justify-between">
                    <Link :href="route('profile.edit')"
                        ...
                        <div>
                            ...
                            <div class="text-[10px] uppercase text-gold-600 font-bold">{{ $page.props.auth.user.role }}
                            </div>
                        </div>
                    </Link>
        ...
        <main class="md:ml-64 min-h-screen transition-all duration-300">
            ...
            <div class="p-6">
                ...
                <div v-if="$page.props.flash && $page.props.flash.success"
                    class="mb-4 bg-green-100 border-green-200 text-green-800 px-4 py-3 rounded relative" role="alert">
                    <strong class="font-bold">Success!</strong>
                    <span class="block sm:inline ml-2">{{ $page.props.flash.success }}</span>
                </div>
                <div v-if="$page.props.flash && $page.props.flash.error"
                    class="mb-4 bg-red-100 border-red-200 text-red-800 px-4 py-3 rounded relative" role="alert">
